...
pub async fn create_router(connection: AppState, cors: CorsLayer) -> Router {
    ...
    Router::new()
        .nest("/loony_api/auth", auth_routes)
        .nest("/loony_api/blog", blog_routes)
        .nest("/loony_api/book", book_routes)
        .nest("/loony_api/tag", tag_routes)
        .nest("/loony_api/user", user_routes)
        .route("/loony_api/upload_file", post(upload_file))
        .route("/loony_api/blog/:uid/:size/:filename", get(get_blog_file))
        .route("/loony_api/book/:uid/:size/:filename", get(get_book_file))
        .route("/loony_api/tmp/:uid/:size/:filename", get(get_tmp_file))
        .route("/", get(home))
